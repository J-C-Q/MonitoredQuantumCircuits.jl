...
features:
  ...
  - icon: <img width="64" height="64" src="https://docs.makie.org/stable/logo.svg" alt="GUI"/>
    ...
    link: /gui
  - icon: <img width="50" height="50" src="https://static-00.iconduck.com/assets.00/ssh-original-icon-424x512-h0n4fvf0.png" alt="Remote"/>
    title: Remote
