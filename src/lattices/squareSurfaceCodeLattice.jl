struct SquareSurfaceCodeLattice <: Lattice
    graph::Graph
    sizeX::Int64
    sizeY::Int64
    ...
    function SquareSurfaceCodeLattice(sizeX::Integer, sizeY::Integer)
...
function visualize(io::IO, lattice::SquareSurfaceCodeLattice)
