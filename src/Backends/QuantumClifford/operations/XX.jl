...
function apply!(state::QC.MixedDestabilizer, ::MonitoredQuantumCircuits.XX, p1::Integer, p2::Integer)
    QC.project!(state, QC.embed(state.tab.nqubits, (p1, p2), QC.P"XX"), keep_result=false)
end
